#!/bin/python3
"""
This is a script to clear directories of SMore machine learning project
This script will clear all files under [model, output, progress, result]
